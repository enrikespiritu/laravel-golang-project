...
<div class="container mt-5">
    <h2 class="mb-4">City A: Buy Ticket</h2>

    <!-- Create Item Form -->
    <form id="createItemForm">
        <input type="hidden" id="route_from" name="route_from" value="city_a"/>
        <input type="hidden" id="trip" name="trip" value="outbound" />
        <div class="form-row">
...
$(function(){
    ...
    // Refresh computation when changing route or number of tickets
    $('#num_tickets, #route_to').on('change', function() { 
        computePrice()
    });
